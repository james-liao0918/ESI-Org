...
class EIDBlockchain:
    ...
    def __init__(self, name, consensus_type="PoW"):
        ...
        self.nodes = []  # List of nodes in the EID-01 network
...
if __name__ == "__main__":
    # Initialize blockchain with PoS consensus, for example
    eid_blockchain = EIDBlockchain(name="EID-01", consensus_type="PoS")
    ...
    eid_blockchain.add_transaction(transaction)
    
    # Start block creation
    eid_blockchain.start_block_creation()
